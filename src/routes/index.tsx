  ...
  return (
    <div className="min-h-screen stars-subtle overflow-x-hidden">
      ...
      <section className="relative overflow-hidden bg-void text-stardust min-h-[85vh] flex flex-col justify-start">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            ...
            style={{
              ...
              right: "-150px",
              background:
                "radial-gradient(circle, oklch(0.55 0.20 340 / 0.3) 0%, oklch(0.22 0.16 300 / 0.1) 60%, transparent 70%)",
            }}
          />
          ...
          <svg
            className="absolute"
            style={{ top: "10%", right: "10%", width: "120px", height: "120px" }}
            viewBox="0 0 120 120"
            fill="none"
          >
            <circle
              ...
              cy="60"
              r="30"
              stroke="oklch(0.55 0.20 340 / 0.3)"
              strokeWidth="2"
              fill="oklch(0.55 0.20 340 / 0.06)"
            />
            <ellipse
              cx="60"
              cy="60"
              rx="55"
              ry="14"
              stroke="oklch(0.70 0.14 300 / 0.25)"
              strokeWidth="1.5"
              fill="none"
            />
          ...
          <svg
            className="absolute"
            style={{ bottom: "15%", right: "25%", width: "130px", height: "130px" }}
            viewBox="0 0 130 130"
            fill="none"
          >
            <circle
              ...
              cy="65"
              r="35"
              stroke="oklch(0.22 0.16 300 / 0.3)"
              strokeWidth="2"
              fill="oklch(0.22 0.16 300 / 0.06)"
            />
            <ellipse
              cx="65"
              cy="65"
              rx="60"
              ry="15"
              stroke="oklch(0.55 0.20 340 / 0.2)"
              strokeWidth="1.5"
              fill="none"
            />
          ...
          <svg
            className="absolute"
            style={{ top: "60%", left: "5%", width: "28px", height: "28px" }}
            viewBox="0 0 24 24"
            fill="none"
          >
            <path
              d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 16.8l-6.2 4.5 2.4-7.4L2 9.4h7.6z"
              fill="oklch(0.55 0.20 340 / 0.25)"
            />
          </svg>
          ...
          <svg
            className="absolute"
            style={{ bottom: "15%", left: "20%", width: "80px", height: "20px" }}
            viewBox="0 0 80 20"
            fill="none"
          >
            <path
          ...
          <div
            className="absolute w-3 h-3 rounded-full bg-cosmic/30"
            style={{ top: "30%", left: "15%" }}
          />
          <div
            className="absolute w-2 h-2 rounded-full bg-stellar/25"
            style={{ top: "60%", left: "25%" }}
          />
          <div
            className="absolute w-4 h-4 rounded-full bg-cosmic/20"
            style={{ top: "45%", right: "20%" }}
          />
          <div
            className="absolute w-2 h-2 rounded-full bg-nebula-soft/20"
            style={{ top: "75%", left: "45%" }}
          />
          <div
            className="absolute w-3 h-3 rounded-full bg-stellar/15"
            style={{ top: "20%", right: "35%" }}
          />
          <div
            className="absolute w-2 h-2 rounded-full bg-cosmic/25"
            style={{ top: "80%", right: "40%" }}
          />
          <div
            className="absolute w-3 h-3 rounded-full bg-stellar/20"
        ...
        {/* Conteúdo */}
        <div
          className="relative z-10 max-w-6xl mx-auto w-full px-6 pt-24 md:pt-32 pb-16 md:pb-20"
        ...
        >
          <div className="grid md:grid-cols-[1.2fr_1fr] gap-10 items-center h-full">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h1 className="font-display font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-wide max-w-full overflow-hidden">
                <span
                  className="inline-block overflow-hidden whitespace-nowrap border-r-2 border-cosmic-soft text-cosmic-soft"
                  style={{
                    animation: "typing 2.5s steps(14) forwards, cursor-type 2.5s steps(1) forwards",
                  }}
                >
                  Olá, me chamo
                </span>
                ...
                <span className="inline-block" style={{ width: "max-content" }}>
                  <span
                    className="inline-block overflow-hidden whitespace-nowrap text-cosmic-soft align-bottom"
                    style={{
                      borderRight: "2px solid transparent",
                      animation:
                        "typing 1.5s steps(8) 2.5s forwards, cursor-type-gio 1.5s steps(1) 2.5s forwards, blink-terminal 0.8s steps(1) 4s infinite",
                      width: 0,
                    }}
                  >
                    Giovanna
              ...
              <p className="mt-5 text-base md:text-lg text-stardust/60 max-w-lg font-sans leading-relaxed">
                Sou desenvolvedora front-end e estou migrando para UX/UI, unindo minha experiência
                com código ao meu interesse por criar experiências digitais mais intuitivas e
                funcionais.
              </p>
      ...
      <section id="sobre" className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        <div className="grid md:grid-cols-[1fr_1.2fr] gap-10 md:gap-12 items-start">
          ...
          <div>
            ...
            <h2 className="mt-2 text-3xl sm:text-4xl md:text-5xl font-extrabold text-void">
              UX/UI Designer & dev front-end.
            </h2>
            <div className="mt-6 space-y-4 text-muted-foreground">
              <p>
                sou Giovanna, UX/UI Designer e front-end dev de São Paulo. comecei escrevendo
                <code className="font-mono text-cosmic font-semibold"> &lt;div&gt;</code> e hoje uno
                design com código pra criar interfaces que funcionam de verdade.
              </p>
              <p>
                tô cursando pós em UX pela Belas Artes e formada em Análise e Desenvolvimento de
                Sistemas. no dia a dia, trabalho com HTML, CSS, JavaScript, PHP, Figma e IA
                generativa, sempre buscando usabilidade, acessibilidade e performance.
              </p>
            </div>
      ...
      <section id="projetos" className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {projects.map((p, i) => (
            ...
            >
              ...
              <div className="p-5 md:p-6 border-t-2 border-void">
                ...
                <h3 className="text-lg md:text-xl font-bold text-void">{p.title}</h3>
                <p className="text-sm text-muted-foreground mt-1 line-clamp-2">{p.tagline}</p>
                <div className="mt-3 flex gap-1.5 flex-wrap">
                  {p.tools.slice(0, 3).map((t) => (
                    <span
                      key={t}
                      className="text-[10px] md:text-xs font-mono uppercase tracking-wider px-2 py-0.5 rounded-full bg-nebula-soft text-nebula border border-nebula/20"
                    >
                      {t}
                    </span>
                  ))}
      ...
      {/* JORNADA — fundo claro */}
      <section id="jornada" className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10">
          <div className="space-y-8">
            <div className="sticker-card p-6">
              <h3 className="font-mono text-sm uppercase tracking-widest text-cosmic mb-4">
                💼 trabalho
              </h3>
            ...
            <div className="sticker-card p-6">
              <h3 className="font-mono text-sm uppercase tracking-widest text-nebula mb-4">
                🎓 estudos
              </h3>
              <ul className="space-y-4">
                {journey.study.map((s) => (
            ...
            <div className="grid grid-cols-2 gap-3">
              {journey.skills.map((s) => {
                ...
                return (
                  <div
                    key={s.name}
                    className="flex items-center gap-3 p-3 rounded-lg bg-cosmic-soft/40 border border-cosmic/10 hover:bg-cosmic-soft transition"
                  >
                    <span
                      className="w-8 h-8 flex items-center justify-center rounded-md bg-stardust border border-nebula/20 text-nebula shrink-0"
                      aria-hidden
                    >
                      {LucideIcon ? <LucideIcon size={18} strokeWidth={2} /> : null}
                    </span>
                    <span className="font-mono text-sm font-medium text-void break-words">
                      {s.name}
                    </span>
                  </div>
                );
                ...
                >
                  <div className="polaroid">
                    <span
                      className="pin"
                      style={{
                        background: i % 2 === 0 ? "oklch(0.22 0.16 300)" : "oklch(0.55 0.20 340)",
                      }}
                    />
                    <img
                      src={p.src}
                      ...
                      loading="lazy"
                    />
                    <p className="mt-2 text-center font-mono text-xs text-void">{p.cap}</p>
                  </div>
                </div>
              ))}
            </div>
